;
; RCS-ID: $Id: agtk.iss,v 1.94 2004-06-01 17:02:46 judson Exp $
;
...
[Run]
Filename: {reg:HKLM\Software\Python\PythonCore\2.{#PythonSubVersion}\InstallPath,|C:\Python2{#PythonSubVersion}}\python.exe; Description: Install shared apps system wide.; Flags: runhidden; Parameters: {app}\bin\agpm.py -s --post-install
