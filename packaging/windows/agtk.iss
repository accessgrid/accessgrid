;
; RCS-ID: $Id: agtk.iss,v 1.82 2004-05-18 17:40:46 judson Exp $
;
...
Root: HKCR; Subkey: x-ag-venueclient\shell\Open\command; ValueType: string; ValueName: ; ValueData: "\""{reg:HKLM\Software\Python\PythonCore\2.{#PythonSubVersion}\InstallPath,|C:\Python2{#PythonSubVersion}}\python.exe \""{app}\\bin\\GoToVenue.py --file %1\""\"""
[Tasks]
