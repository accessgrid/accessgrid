...
# Created:     2003/05/06
# RCS-ID:      $Id: Config.py,v 1.15 2004-04-24 20:24:36 turam Exp $
# Copyright:   (c) 2002
# Licence:     See COPYING.TXT
#-----------------------------------------------------------------------------
"""
"""
__revision__ = "$Id: Config.py,v 1.15 2004-04-24 20:24:36 turam Exp $"
...
class AGTkConfig(AccessGrid.Config.AGTkConfig):
    ...
    def GetConfigDir(self):
        ...
        try:
            ...
            self.configDir = os.path.join(AGTkBasePath, "Config")
