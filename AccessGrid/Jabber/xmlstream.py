...
# $Id: xmlstream.py,v 1.1 2005-05-06 19:32:40 lefvert Exp $
...
class Stream(NodeBuilder):
    ...
    def write(self,raw_data):
        ...
        try:
            ...
            self.DEBUG("xmlstream write threw error: %s" % E,DBG_CONN_ERROR)
...
class Client(Stream):
    ...
    def _setupComms(self):
        self.DEBUG("self._connection=%s" % {TCP:"TCP",TCP_SSL:"SSL",STDIO:"STDIO"}[self._connection])
        ...
        self.DEBUG("self._read, _write=%s,%s" % (self._read, self._write))
