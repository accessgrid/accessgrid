...
#
# Created:     
# RCS-ID:      $Id: Subject.py,v 1.15 2005-11-01 18:39:35 turam Exp $
# Copyright:   (c) 2002
...
__revision__ = "$Id: Subject.py,v 1.15 2005-11-01 18:39:35 turam Exp $"
...
class Subject:
    ...
    """
    def __init__(self, name=None, auth_type=None, auth_data = None, id = str(GUID())):
        """
