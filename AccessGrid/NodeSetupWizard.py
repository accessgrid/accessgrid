...
class NodeSetupWizard(wxWizard):
    ...
    def __init__(self, parent):
        ...
        self.page2 = VideoCaptureWindow(self, self.nodeInterface,
                                        "Video Capture Machine")
        self.page3 = VideoCaptureWindow2(self, self.nodeInterface,
                                         "Video Capture Machine")
        self.page4 = VideoDisplayWindow(self, self.nodeInterface,
                                        "Video Display Machine")
        self.page5 = AudioWindow(self, self.nodeInterface,
                                 "Audio Machine")
        self.page6 = ConfigWindow(self, self.nodeInterface, "Your Node Setup")
        ...
        try:
            self.nodeInterface.StartNodeService()
        except:
            ...
            # Stop node service
            node = self.nodeInterface.GetNodeService()
...
class VideoCaptureWindow(TitledPage):
    ...
    '''
    def __init__(self, parent, nodeInterface, title):
        TitledPage.__init__(self, parent, title)
        self.parent = parent
        self.nodeInterface = nodeInterface
    ...
    def Validate(self):
        ...
        try:
            self.nodeInterface.CheckServiceManager(self.machineCtrl.GetValue(),
        ...
        if self.canConnect:
            cards = []
            try:
                cards = self.nodeInterface.GetCaptureCards(self.machineCtrl.GetValue(), self.portCtrl.GetValue())
            except:
...
class VideoDisplayWindow(TitledPage):
    ...
    def Validate(self):
        ...
        wxBeginBusyCursor()
        try:
            self.nodeInterface.CheckServiceManager(self.machineCtrl.GetValue(), self.portCtrl.GetValue())
            self.canConnect = true
    ...
    def Validate(self):
        ...
        if self.videoCaptUrl:
            ...
            try:
                ...
                self.nodeInterface.AddServiceManager(text, self.videoCaptUrl)
            ...
            try:
                ...
                self.nodeInterface.AddService( self.videoCaptUrl, "VideoProducerService", self.cameraPorts)
        ...
        if self.videoDispUrl:
            ...
            try:
                ...
                self.nodeInterface.AddServiceManager(text, self.videoDispUrl)
            except:
                # We still want to continue even if a service manager is already present
            ...
            try:
                ...
                self.nodeInterface.AddService(self.videoDispUrl, "VideoConsumerService")
        ...
        if self.audioUrl:
            ...
            try:
                ...
                self.nodeInterface.AddServiceManager(text, self.audioUrl)
            except:
                # We still want to continue even if a service manager is already present
            ...
            try:
                # Add audio service
                self.nodeInterface.AddService(self.audioUrl, "AudioService")
        ...
        try:
            self.nodeInterface.GetNodeService().StoreConfiguration(self.name)
        except:
        ...
        try:
            self.nodeInterface.GetNodeService().SetDefaultConfiguration(self.name)
        except:
