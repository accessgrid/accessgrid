...
# Created:     2003/17/01
# RCS-ID:      $Id: setup.py,v 1.105 2006-05-30 03:09:30 willing Exp $
# Copyright:   (c) 2003
...
linux_data = [('etc/AccessGrid3/Config',
              ...
              ('bin', [r"tools/GoToVenue.py", r"tools/ag-avahi-discover.py", r"sharedapps/VenueVNC/server/VenueVNCServer.py"]),
              ]
