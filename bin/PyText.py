...
#
# Created:     2003/01/02
# RCS-ID:      $Id: PyText.py,v 1.1 2003-02-06 14:44:55 judson Exp $
# Copyright:   (c) 2002
...
class SimpleTextProcessor:
    ...
    def ProcessForDisplay(self, data):
        """ """

    def ProcessForLocalDisplay(self, text):
        """ """
    ...
    def ProcessNetwork(self):
        ...
        while self.running:
            ...
            self.ProcessForLocalDisplay(event['Data'])

class MyTextClient(wxFrame):
    ...
    def __init__(self, *args, **kwds):
        ...
        # begin wxGlade: MyTextClient.__init__
    ...
    def __set_properties(self):
        # begin wxGlade: MyTextClient.__set_properties
    ...
    def __do_layout(self):
        # begin wxGlade: MyTextClient.__do_layout
...
if __name__ == "__main__":
    ...
    TextFrame = MyTextClient(None, -1, "", host = sys.argv[1],
                                           port = int(sys.argv[2]))
